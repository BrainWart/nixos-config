...
let
  ...
  commit = "54b33a75e0b4593b77f9a217323c4b27a42f4073";
in
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-6KVgEORBB1z9/ogV8TDF1m3A989MAV1cquJH80prYVs=";
  };
  ...
  buildPhase = ''
    ...
    find ./lib/vscode \( -path "*/node_modules/*" -or -path "*/extensions/*" \) \
      -and -type f -name "yarn.lock" -printf "%h\n" | \
        xargs -I {} sh -c 'echo {} ; jq -e ".scripts.postinstall" {}/package.json >/dev/null && yarn --cwd {} postinstall --frozen-lockfile --offline || true'
